...
$functions = array(
    ...
    'elediaservice_enrol_users_by_idnumber' => array(
		...
		'capabilities' => 'local/eledia_webservicesuite:access, moodle/course:view, moodle/course:update, moodle/course:viewhiddencourses',
            ...
            'elediaservice_get_enrolment_by_idnumber' => array(
		'classname' => 'eledia_services',
		'methodname' => 'get_enrolment_by_idnumber',
		'classpath' => 'local/eledia_webservicesuite/externallib.php',
		'description' => 'returns a enrolment object according to the given idnumber',
		'type' => 'write',
		'capabilities' => 'local/eledia_webservicesuite:access, moodle/course:enrolreview',
	),
);
